...
/* harmony import */ var _add_book_add_book_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./add-book/add-book.component */ "./src/app/add-book/add-book.component.ts");
/* harmony import */ var _add_reader_add_reader_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-reader/add-reader.component */ "./src/app/add-reader/add-reader.component.ts");
...
/* harmony import */ var _edit_reader_edit_reader_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit-reader/edit-reader.component */ "./src/app/edit-reader/edit-reader.component.ts");
...
/* harmony import */ var _core_readers_resolver_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./core/readers-resolver.service */ "./src/app/core/readers-resolver.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], resolve: { resolvedBooks: _core_books_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BooksResolverService"] } },
    { path: 'addbook', component: _add_book_add_book_component__WEBPACK_IMPORTED_MODULE_2__["AddBookComponent"] },
    { path: 'addreader', component: _add_reader_add_reader_component__WEBPACK_IMPORTED_MODULE_3__["AddReaderComponent"] },
    { path: 'editreader/:id', component: _edit_reader_edit_reader_component__WEBPACK_IMPORTED_MODULE_6__["EditReaderComponent"] },
    { path: 'editbook/:id', component: _edit_book_edit_book_component__WEBPACK_IMPORTED_MODULE_5__["EditBookComponent"] },
    { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
    { path: 'dashboard', component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], resolve: { resolvedBooks: _core_books_resolver_service__WEBPACK_IMPORTED_MODULE_7__["BooksResolverService"], resolvedReaders: _core_readers_resolver_service__WEBPACK_IMPORTED_MODULE_8__["ReaderResolverService"] } },
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/bookTrackerError */ "./src/app/models/bookTrackerError.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BookTrackerErrorHandlerService = /** @class */ (function () {
    ...
    BookTrackerErrorHandlerService.prototype.handleError = function (error) {
        var customError = new _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_1__["BookTrackerError"]();
...
var CacheInterceptor = /** @class */ (function () {
    ...
    CacheInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [typeof (_a = typeof app_services_http_cache_service__WEBPACK_IMPORTED_MODULE_4__["HttpCacheService"] !== "undefined" && app_services_http_cache_service__WEBPACK_IMPORTED_MODULE_4__["HttpCacheService"]) === "function" ? _a : Object])
    ], CacheInterceptor);
...
/* harmony import */ var _core_module_import_guard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/module-import-guard */ "./src/app/core/module-import-guard.ts");
...
var CoreModule = /** @class */ (function () {
    function CoreModule(parentModule) {
        Object(_core_module_import_guard__WEBPACK_IMPORTED_MODULE_5__["throwIfAlreadyLoaded"])(parentModule, 'CoreModule');
    }
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.mostPopularBook = _data__WEBPACK_IMPORTED_MODULE_4__["allBooks"][0];
    }
    ...
    DataService.prototype.handleHttpError = function (error) {
        var dataError = new _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_5__["BookTrackerError"]();
...
/*!**************************************************!*\
  !*** ./src/app/core/readers-resolver.service.ts ***!
  \**************************************************/
/*! exports provided: ReaderResolverService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReaderResolverService", function() { return ReaderResolverService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _core_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/data.service */ "./src/app/core/data.service.ts");
...
var ReaderResolverService = /** @class */ (function () {
    function ReaderResolverService(dataService) {
        this.dataService = dataService;
    }
    ReaderResolverService.prototype.resolve = function (route, state) {
        return this.dataService.getAllReaders()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(err); }));
    };
    ReaderResolverService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        }),
        __metadata("design:paramtypes", [_core_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"]])
    ], ReaderResolverService);
    return ReaderResolverService;
}());
...
/* harmony import */ var _core_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/data.service */ "./src/app/core/data.service.ts");
/* harmony import */ var _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/bookTrackerError */ "./src/app/models/bookTrackerError.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        if (resolvedData instanceof _models_bookTrackerError__WEBPACK_IMPORTED_MODULE_4__["BookTrackerError"]) {
...
module.exports = __webpack_require__(/*! C:\Users\bsegunto\Desktop\Book tracker with update issue\BookTracker Demo\src\main.ts */"./src/main.ts");
