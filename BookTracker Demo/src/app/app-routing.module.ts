...
import { ReaderResolverService } from './core/readers-resolver.service';
...
const routes: Routes = [
  ...
  { path: 'dashboard', component: DashboardComponent, resolve: {resolvedBooks: BooksResolverService,resolvedReaders:ReaderResolverService} },
];
